...
To learn how to add an API service using the Amplify Central CLI, see [Build and manage API services in your environments](/docs/central/cli_central/cli_apiservices).
